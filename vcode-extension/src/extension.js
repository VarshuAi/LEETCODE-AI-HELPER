...
function activate(context) {
    ...
    let applyThemeCmd = vscode.commands.registerCommand('vcode.applyTheme', async () => {
        ...
        vscode.window.showInformationMessage('Welcome to VCode! Carbon Slate Theme applied.');
    });
    ...
    let applyMacThemeCmd = vscode.commands.registerCommand('vcode.applyMacTheme', async () => {
        ...
        vscode.window.showInformationMessage('Welcome to VCode! macOS Dark Theme applied.');
    });
